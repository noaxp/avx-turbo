...
ISA get_isas() {
    ...
    ret |= psnip_cpu_feature_check(PSNIP_CPU_FEATURE_X86_AMX_TILE) ? AMXTILE  : 0;
    ret |= psnip_cpu_feature_check(PSNIP_CPU_FEATURE_X86_AMX_INT8) ? AMXINT8  : 0;
    ret |= psnip_cpu_feature_check(PSNIP_CPU_FEATURE_X86_AMX_BF16) ? AMXBF16  : 0;
    return (ISA)ret;
}
...
int main(int argc, char** argv) {
    ...
    printf("CPU supports AMX-TILE : [%s]\n", isas_supported & AMXTILE  ? "YES" : "NO ");
    printf("CPU supports AMX-INT8 : [%s]\n", isas_supported & AMXINT8  ? "YES" : "NO ");
    printf("CPU supports AMX-BF16 : [%s]\n", isas_supported & AMXBF16  ? "YES" : "NO ");
