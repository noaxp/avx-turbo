...
enum PSnipCPUFeature {
  ...
  PSNIP_CPU_FEATURE_X86_AMX_BF16        = PSNIP_CPU_FEATURE_X86 | (7 << 16) | (3 << 8) | (22),
  PSNIP_CPU_FEATURE_X86_AMX_TILE        = PSNIP_CPU_FEATURE_X86 | (7 << 16) | (3 << 8) | (24),
  PSNIP_CPU_FEATURE_X86_AMX_INT8        = PSNIP_CPU_FEATURE_X86 | (7 << 16) | (3 << 8) | (25),
